...
/////// Diffuse:
                ...
                float4 node_9741 = tex2D(_AmbientOcclusion,TRANSFORM_TEX(i.uv0, _AmbientOcclusion));
                indirectDiffuse += node_9741.rgb; // Diffuse Ambient Light
...
////// Emissive:
                ...
                float3 emissive = (_EmissivePower*node_5666);
/// Final Color:
